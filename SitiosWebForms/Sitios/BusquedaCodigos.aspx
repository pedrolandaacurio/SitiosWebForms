        ...
        <div class="form-horizontal">
            <asp:FormView runat="server" ID="SitiosForm" DataKeyNames="CodSitio" DataSourceID="SqlDataSource1" AllowPaging="True" DefaultMode="ReadOnly" CssClass="form-horizontal" Width="100%">
                ...
                <ItemTemplate>
                    ...
                    <br />
                    <div class="btn-group btn-group-justified">
                        <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#AgregarVictimaModal">Agregar víctimas</a>
                        <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#AgregarTestigoModal">Agregar testigo</a>
                        <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#AgregarInformanteModal">Agregar informante</a>
                    </div>
                </ItemTemplate>
                <EmptyDataTemplate>
                    <center>
            ...
            <!--Panel de víctimas-->
            <asp:UpdatePanel runat="server" ID="UpdVictimasGrid">
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="AgregarVictima" />
                </Triggers>
                <ContentTemplate>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <asp:GridView runat="server" ID="GridViewVictimas" AutoGenerateColumns="False" DataKeyNames="IdVictima" DataSourceID="SqlDataSource3" AllowSorting="True" CssClass="table table-bordered table-hover table-condensed table-striped">
                                    <Columns>
                                        ...
                                        <asp:CommandField ShowDeleteButton="True" ButtonType="Button" ControlStyle-CssClass="btn btn-default btn-xs"></asp:CommandField>
                                    </Columns>
                                    <EmptyDataTemplate>
                                        No hay datos aún...
                                    </EmptyDataTemplate>
            ...
            <!--Panel de Testigos-->
            <asp:UpdatePanel runat="server" ID="UpdTestigosGrid">
                <ContentTemplate>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Testigos
            ...
            <asp:UpdatePanel runat="server" ID="UpdInformantesGrid">
                <ContentTemplate>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Informantes
                        ...
                        <div class="panel-body">
                            <asp:GridView runat="server" ID="GridViewInformantes" AutoGenerateColumns="False" DataKeyNames="IdInformante" DataSourceID="SqlDataSource5" AllowSorting="True" CssClass="table table-bordered table-striped table-condensed table-hover">
                                <Columns>
                                    <asp:BoundField DataField="CodSitio" HeaderText="CodSitio" SortExpression="CodSitio" Visible="false"></asp:BoundField>
                                    <asp:BoundField DataField="IdInformante" HeaderText="IdInformante" ReadOnly="True" InsertVisible="False" SortExpression="IdInformante" Visible="false"></asp:BoundField>
                                    <asp:BoundField DataField="Nombres" HeaderText="Nombres" SortExpression="Nombres"></asp:BoundField>
                                    <asp:BoundField DataField="ApellidoPaterno" HeaderText="Apellido Paterno" SortExpression="ApellidoPaterno"></asp:BoundField>
                                    <asp:BoundField DataField="ApellidoMaterno" HeaderText="Apellido Materno" SortExpression="ApellidoMaterno"></asp:BoundField>
                                    <asp:CommandField ShowEditButton="True" ShowDeleteButton="True" ControlStyle-CssClass="btn btn-default btn-xs"></asp:CommandField>
                                </Columns>
                                <EmptyDataTemplate>
                                    No hay datos aún...
                                </EmptyDataTemplate>
            ...
            <!-- Modal de víctimas -->
            <div class="modal fade" id="AgregarVictimaModal" tabindex="-1" role="dialog" aria-labelledby="VictimaModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="VictimaModalLabel">Agregar víctima</h4>
                        </div>
                        <div class="modal-body">
                            <asp:UpdatePanel runat="server" ID="agregarvictimaupd">
                                <ContentTemplate>
            ...
            <!--Modal de Testigos-->
            <div class="modal fade" id="AgregarTestigoModal" tabindex="-1" role="dialog" aria-labelledby="TestigoModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="TestigoModalLabel">Agregar testigo</h4>
                        </div>
                        <div class="modal-body">
                            <asp:FormView runat="server" ID="AgregarTestigo" DataKeyNames="IdTestigo" DataSourceID="SqlDataSource6" DefaultMode="Insert">
                                <EditItemTemplate>
                                    CodSitio:
                                <asp:TextBox Text='<%# Bind("CodSitio") %>' runat="server" ID="CodSitioTextBox" /><br />
                                    IdTestigo:
                                <asp:Label Text='<%# Eval("IdTestigo") %>' runat="server" ID="IdTestigoLabel1" /><br />
                                    Nombres_Test:
                                <asp:TextBox Text='<%# Bind("Nombres_Test") %>' runat="server" ID="Nombres_TestTextBox" /><br />
                                    ApellidoPaterno_Tes:
                                <asp:TextBox Text='<%# Bind("ApellidoPaterno_Tes") %>' runat="server" ID="ApellidoPaterno_TesTextBox" /><br />
                                    ApellidoMaterno_Tes:
                                <asp:TextBox Text='<%# Bind("ApellidoMaterno_Tes") %>' runat="server" ID="ApellidoMaterno_TesTextBox" /><br />
                                    <asp:LinkButton runat="server" Text="Actualizar" CommandName="Update" ID="UpdateButton" CausesValidation="True" />&nbsp;<asp:LinkButton runat="server" Text="Cancelar" CommandName="Cancel" ID="UpdateCancelButton" CausesValidation="False" />
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                    <div class="form-horizontal">
                                    ...
                                    <asp:TextBox Text='<%# Bind("CodSitio") %>' runat="server" ID="CodSitioTextBox" Visible="false" />
                                    <div class="btn-group btn-group-justified">
                                        <asp:LinkButton runat="server" Text="Guardar" CommandName="Insert" ID="InsertButton" CausesValidation="True" CssClass="btn btn-primary" />
                                ...
                                <asp:Label Text='<%# Bind("CodSitio") %>' runat="server" ID="CodSitioLabel" /><br />
                                    IdTestigo:
                                <asp:Label Text='<%# Eval("IdTestigo") %>' runat="server" ID="IdTestigoLabel" /><br />
                                    Nombres_Test:
                                <asp:Label Text='<%# Bind("Nombres_Test") %>' runat="server" ID="Nombres_TestLabel" /><br />
                                    ApellidoPaterno_Tes:
                                <asp:Label Text='<%# Bind("ApellidoPaterno_Tes") %>' runat="server" ID="ApellidoPaterno_TesLabel" /><br />
                                    ApellidoMaterno_Tes:
                                <asp:Label Text='<%# Bind("ApellidoMaterno_Tes") %>' runat="server" ID="ApellidoMaterno_TesLabel" /><br />
                                    <asp:LinkButton runat="server" Text="Editar" CommandName="Edit" ID="EditButton" CausesValidation="False" />&nbsp;<asp:LinkButton runat="server" Text="Eliminar" CommandName="Delete" ID="DeleteButton" CausesValidation="False" />&nbsp;<asp:LinkButton runat="server" Text="Nuevo" CommandName="New" ID="NewButton" CausesValidation="False" />
                                </ItemTemplate>
                            </asp:FormView>
                            <asp:SqlDataSource runat="server" ID="SqlDataSource6" ConflictDetection="CompareAllValues" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' DeleteCommand="DELETE FROM [Testigos] WHERE [IdTestigo] = @original_IdTestigo AND (([CodSitio] = @original_CodSitio) OR ([CodSitio] IS NULL AND @original_CodSitio IS NULL)) AND (([Nombres_Test] = @original_Nombres_Test) OR ([Nombres_Test] IS NULL AND @original_Nombres_Test IS NULL)) AND (([ApellidoPaterno_Tes] = @original_ApellidoPaterno_Tes) OR ([ApellidoPaterno_Tes] IS NULL AND @original_ApellidoPaterno_Tes IS NULL)) AND (([ApellidoMaterno_Tes] = @original_ApellidoMaterno_Tes) OR ([ApellidoMaterno_Tes] IS NULL AND @original_ApellidoMaterno_Tes IS NULL))" InsertCommand="INSERT INTO [Testigos] ([CodSitio], [Nombres_Test], [ApellidoPaterno_Tes], [ApellidoMaterno_Tes]) VALUES (@CodSitio, @Nombres_Test, @ApellidoPaterno_Tes, @ApellidoMaterno_Tes)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [Testigos] WHERE ([CodSitio] = @CodSitio)" UpdateCommand="UPDATE [Testigos] SET [CodSitio] = @CodSitio, [Nombres_Test] = @Nombres_Test, [ApellidoPaterno_Tes] = @ApellidoPaterno_Tes, [ApellidoMaterno_Tes] = @ApellidoMaterno_Tes WHERE [IdTestigo] = @original_IdTestigo AND (([CodSitio] = @original_CodSitio) OR ([CodSitio] IS NULL AND @original_CodSitio IS NULL)) AND (([Nombres_Test] = @original_Nombres_Test) OR ([Nombres_Test] IS NULL AND @original_Nombres_Test IS NULL)) AND (([ApellidoPaterno_Tes] = @original_ApellidoPaterno_Tes) OR ([ApellidoPaterno_Tes] IS NULL AND @original_ApellidoPaterno_Tes IS NULL)) AND (([ApellidoMaterno_Tes] = @original_ApellidoMaterno_Tes) OR ([ApellidoMaterno_Tes] IS NULL AND @original_ApellidoMaterno_Tes IS NULL))">
                                <DeleteParameters>
                                    <asp:Parameter Name="original_IdTestigo" Type="Int32"></asp:Parameter>
                                    <asp:Parameter Name="original_CodSitio" Type="String"></asp:Parameter>
                                    <asp:Parameter Name="original_Nombres_Test" Type="String"></asp:Parameter>
            ...
            <!--Modal de Informantes-->
            <div class="modal fade" id="AgregarInformanteModal" tabindex="-1" role="dialog" aria-labelledby="InformanteModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="InformanteModalLabel">Agregar testigo</h4>
                        </div>
                        <div class="modal-body">
                            <asp:FormView runat="server" ID="AgregarInformante" DataKeyNames="IdInformante" DataSourceID="SqlDataSource7" DefaultMode="Insert">

                                <EditItemTemplate>
                                    CodSitio:
                                <asp:TextBox Text='<%# Bind("CodSitio") %>' runat="server" ID="CodSitioTextBox" /><br />
                                    IdInformante:
                                <asp:Label Text='<%# Eval("IdInformante") %>' runat="server" ID="IdInformanteLabel1" /><br />
                                    Nombres:
                                <asp:TextBox Text='<%# Bind("Nombres") %>' runat="server" ID="NombresTextBox" /><br />
                                    ApellidoPaterno:
                                <asp:TextBox Text='<%# Bind("ApellidoPaterno") %>' runat="server" ID="ApellidoPaternoTextBox" /><br />
                                ...
                                <asp:Label Text='<%# Bind("CodSitio") %>' runat="server" ID="CodSitioLabel" /><br />
                                    IdInformante:
                                <asp:Label Text='<%# Eval("IdInformante") %>' runat="server" ID="IdInformanteLabel" /><br />
                                    Nombres:
                                <asp:Label Text='<%# Bind("Nombres") %>' runat="server" ID="NombresLabel" /><br />
                                    ApellidoPaterno:
                                <asp:Label Text='<%# Bind("ApellidoPaterno") %>' runat="server" ID="ApellidoPaternoLabel" /><br />
                            ...
                            <asp:SqlDataSource runat="server" ID="SqlDataSource7" ConflictDetection="CompareAllValues" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' DeleteCommand="DELETE FROM [Informantes] WHERE [IdInformante] = @original_IdInformante AND (([CodSitio] = @original_CodSitio) OR ([CodSitio] IS NULL AND @original_CodSitio IS NULL)) AND (([Nombres] = @original_Nombres) OR ([Nombres] IS NULL AND @original_Nombres IS NULL)) AND (([ApellidoPaterno] = @original_ApellidoPaterno) OR ([ApellidoPaterno] IS NULL AND @original_ApellidoPaterno IS NULL)) AND (([ApellidoMaterno] = @original_ApellidoMaterno) OR ([ApellidoMaterno] IS NULL AND @original_ApellidoMaterno IS NULL))" InsertCommand="INSERT INTO [Informantes] ([CodSitio], [Nombres], [ApellidoPaterno], [ApellidoMaterno]) VALUES (@CodSitio, @Nombres, @ApellidoPaterno, @ApellidoMaterno)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [Informantes] WHERE ([CodSitio] = @CodSitio)" UpdateCommand="UPDATE [Informantes] SET [CodSitio] = @CodSitio, [Nombres] = @Nombres, [ApellidoPaterno] = @ApellidoPaterno, [ApellidoMaterno] = @ApellidoMaterno WHERE [IdInformante] = @original_IdInformante AND (([CodSitio] = @original_CodSitio) OR ([CodSitio] IS NULL AND @original_CodSitio IS NULL)) AND (([Nombres] = @original_Nombres) OR ([Nombres] IS NULL AND @original_Nombres IS NULL)) AND (([ApellidoPaterno] = @original_ApellidoPaterno) OR ([ApellidoPaterno] IS NULL AND @original_ApellidoPaterno IS NULL)) AND (([ApellidoMaterno] = @original_ApellidoMaterno) OR ([ApellidoMaterno] IS NULL AND @original_ApellidoMaterno IS NULL))">
                                <DeleteParameters>
                                    <asp:Parameter Name="original_IdInformante" Type="Int32"></asp:Parameter>
                                    <asp:Parameter Name="original_CodSitio" Type="String"></asp:Parameter>
                                    <asp:Parameter Name="original_Nombres" Type="String"></asp:Parameter>
